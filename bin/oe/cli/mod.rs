...
usage! {
    ...
    }
    {
        ...
        ["API and Console Options – HTTP JSON-RPC"]
            ...
            ARG arg_jsonrpc_apis: (String) = "web3,eth,evm,pubsub,net,parity,parity_pubsub,traces,rpc", or |c: &Config| c.rpc.as_ref()?.apis.as_ref().map(|vec| vec.join(",")),
            "--jsonrpc-apis=[APIS]",
        ...
        ["API and Console Options – WebSockets"]
            ...
            ARG arg_ws_apis: (String) = "web3,eth,evm,pubsub,net,parity,parity_pubsub,traces,rpc", or |c: &Config| c.websockets.as_ref()?.apis.as_ref().map(|vec| vec.join(",")),
            "--ws-apis=[APIS]",
    ...
    fn should_parse_full_config() {
        ...
        assert_eq!(
            ...
            Args {
                ...
                arg_ipc_apis: "web3,eth,evm,net,parity,parity_accounts,personal,traces,rpc,secretstore"
                    .into(),
